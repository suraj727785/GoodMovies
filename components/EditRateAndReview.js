...
const EditRateAndReview = (props) => {
  ...
  const updateRatingAndReview = async () => {
    ...
    if (reviewDetails.comedy === 0) {
      if (comedy !== 0) {
        movieDetails.comedy =
          (movieDetails.comedy * movieDetails.comedyCount + comedy) /
          (movieDetails.comedyCount + 1);
      ...
      if (comedy !== 0) {
        movieDetails.comedy =
          (movieDetails.comedy * movieDetails.comedyCount -
            reviewDetails.comedy +
            comedy) /
          movieDetails.comedyCount;
        movieDetails.comedy = movieDetails.comedy.toFixed(2);
      } else {
        movieDetails.comedy =
          (movieDetails.comedy * movieDetails.comedyCount -
    ...
    if (reviewDetails.horror === 0) {
      if (horror !== 0) {
        movieDetails.horror =
          (movieDetails.horror * movieDetails.horrorCount + horror) /
          (movieDetails.horrorCount + 1);
      ...
      if (horror !== 0) {
        movieDetails.horror =
          (movieDetails.horror * movieDetails.horrorCount -
            reviewDetails.horror +
            horror) /
          movieDetails.horrorCount;
        movieDetails.horror = movieDetails.horror.toFixed(2);
      } else {
        movieDetails.horror =
          (movieDetails.horror * movieDetails.horrorCount -
    ...
    if (reviewDetails.rating === 0) {
      if (rating !== 0) {
        movieDetails.rating =
          (movieDetails.rating * movieDetails.ratingCount + rating) /
      ...
      if (rating !== 0) {
        movieDetails.rating =
          (movieDetails.rating * movieDetails.ratingCount -
            reviewDetails.rating +
            rating) /
          movieDetails.ratingCount;
        movieDetails.rating = movieDetails.rating.toFixed(2);
      } else {
        movieDetails.rating =
          (movieDetails.rating * movieDetails.ratingCount -
    ...
    if (reviewDetails.Action === 0) {
      if (action !== 0) {
        movieDetails.Action =
          (movieDetails.Action * movieDetails.ActionCount + action) /
          (movieDetails.ActionCount + 1);
      ...
      if (action !== 0) {
        movieDetails.Action =
          (movieDetails.Action * movieDetails.ActionCount -
            reviewDetails.Action +
            action) /
          movieDetails.ActionCount;
        movieDetails.Action = movieDetails.Action.toFixed(2);
      } else {
        movieDetails.Action =
          (movieDetails.Action * movieDetails.ActionCount -
    ...
    if (reviewDetails.Drama === 0) {
      if (drama !== 0) {
        movieDetails.Drama =
          (movieDetails.Drama * movieDetails.DramaCount + drama) /
          (movieDetails.DramaCount + 1);
      ...
      if (drama !== 0) {
        movieDetails.Drama =
          (movieDetails.Drama * movieDetails.DramaCount -
            reviewDetails.Drama +
            drama) /
          movieDetails.DramaCount;
        movieDetails.Drama = movieDetails.Drama.toFixed(2);
      } else {
        movieDetails.Drama =
          (movieDetails.Drama * movieDetails.DramaCount - reviewDetails.Drama) /
          (movieDetails.DramaCount - 1);
        movieDetails.Drama = movieDetails.Drama.toFixed(2);
        movieDetails.DramaCount = movieDetails.DramaCount - 1;
      }
    ...
    if (reviewDetails.Thrill === 0) {
      if (thrill !== 0) {
        movieDetails.Thrill =
          (movieDetails.Thrill * movieDetails.ThrillCount + thrill) /
          (movieDetails.ThrillCount + 1);
      ...
      if (thrill !== 0) {
        movieDetails.Thrill =
          (movieDetails.Thrill * movieDetails.ThrillCount -
            reviewDetails.Thrill +
            thrill) /
          movieDetails.ThrillCount;
        movieDetails.Thrill = movieDetails.Thrill.toFixed(2);
      } else {
        movieDetails.Thrill =
          (movieDetails.Thrill * movieDetails.ThrillCount -
    ...
    if (reviewDetails.romance === 0) {
      if (romance !== 0) {
        movieDetails.romance =
          (movieDetails.romance * movieDetails.romanceCount + romance) /
          (movieDetails.romanceCount + 1);
      ...
      if (romance !== 0) {
        movieDetails.romance =
          (movieDetails.romance * movieDetails.romanceCount -
            reviewDetails.romance +
            romance) /
          movieDetails.romanceCount;
        movieDetails.romance = movieDetails.romance.toFixed(2);
      } else {
        movieDetails.romance =
          (movieDetails.romance * movieDetails.romanceCount -
  ...
  const onDeleteReview = async () => {
    ...
    await API.graphql(
      graphqlOperation(deleteReview, { input: { id: props.reviewId } })
    );
    await API.graphql(
      graphqlOperation(updateMovie, {
        input: {
  ...
  const ondeleteReviewAlert = () => {
    Alert.alert("Delete Review", "Want to delete your review?", [
      {
        text: "Cancel",
  ...
  return (
    <View style={styles.rateAndReviewContainer}>
      ...
      <TouchableOpacity
        onPress={ondeleteReviewAlert}
        style={styles.deleteReviewContainer}
      >
