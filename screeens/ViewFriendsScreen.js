...
import {Text,View,StyleSheet,FlatList,ScrollView,RefreshControl,Image} from 'react-native';
    ...
    return (
      ...
      <RefreshControl
        ...
        <View style={styles.noFriendsShowView}>
          <Text style={{fontSize:16}}>Sorry No Friends to show Please add some...</Text>
        </View>:
          <FlatList
        style={{width:'100%'}}
