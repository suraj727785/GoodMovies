...
const MovieDetailsScreen = (props) => {
  ...
  useEffect(() => {
    const fetchdata = async () => {
      ...
      if (movieData.data.getMovie.imageUri === "") {
        image =
          "https://st2.depositphotos.com/3687485/9010/v/600/depositphotos_90102796-stock-illustration-cinema-film-clapper-board-vector.jpg";
      } else {
      ...
      const myReviewData = await API.graphql(
        graphqlOperation(listReviews, {
          filter: {
            movieID: { contains: movieId },
            and: { userID: { contains: userInfo.attributes.sub } },
          },
        })
      );
      const allReviewData = await API.graphql(
        graphqlOperation(listReviews, {
          filter: {
            movieID: { contains: movieId },
            and: { userID: { notContains: userInfo.attributes.sub } },
          },
        })
      );
  ...
  useEffect(() => {
    const subscription = API.graphql(graphqlOperation(onUpdateMovie)).subscribe(
      {
        next: (data) => {
  ...
  return (
    <ScrollView>
      ...
      {selectedMovie === undefined ? (
        ...
        >
          <Image
            style={{ width: 500, height: 400, marginTop: 150 }}
            source={{
          ...
          <View>
            ...
            <View style={styles.detailsContainer}>
              ...
              <Text style={styles.detailsVal}>
                {moment(selectedMovie.releaseDate).format(" DD-MMM-YYYY")}
              </Text>
            </View>
            <View style={styles.detailsContainer}>
            ...
            <View style={styles.ratingsContainer}>
              <Text style={styles.ratingText}>
                ...
                />{" "}
                {selectedMovie.rating}({selectedMovie.ratingCount})
              </Text>
              <Text style={styles.ratingText}>
                Friends Rating:{" "}
                <Image
            ...
            <View style={styles.genreRatingsContainer}>
              <Text style={styles.genreRatingsTitle}>
                Ratings on different Genre:
              </Text>
              <Text style={styles.genreRatingText}>
                Comedy:{" "}
                <Image
                  style={styles.ratingImage}
                  source={require("../assets/images/star-filled.png")}
                />{" "}
                {selectedMovie.comedy}({selectedMovie.comedyCount})
              </Text>
              <Text style={styles.genreRatingText}>
                Romance:{" "}
                <Image
                  ...
                  source={require("../assets/images/star-filled.png")}
                />{" "}
                {selectedMovie.romance}({selectedMovie.romanceCount})
              </Text>
              <Text style={styles.genreRatingText}>
                Drama:{" "}
                <Image
                  ...
                  source={require("../assets/images/star-filled.png")}
                />{" "}
                {selectedMovie.Drama}({selectedMovie.DramaCount})
              </Text>
              <Text style={styles.genreRatingText}>
                Action:{" "}
                <Image
                  ...
                  source={require("../assets/images/star-filled.png")}
                />{" "}
                {selectedMovie.Action}({selectedMovie.ActionCount})
              </Text>
              <Text style={styles.genreRatingText}>
                Thriller:{" "}
                <Image
                  ...
                  source={require("../assets/images/star-filled.png")}
                />{" "}
                {selectedMovie.Thrill}({selectedMovie.ThrillCount})
              </Text>
              <Text style={styles.genreRatingText}>
                Horror:{" "}
                <Image
                  ...
                  source={require("../assets/images/star-filled.png")}
                />{" "}
                {selectedMovie.horror}({selectedMovie.horrorCount})
              </Text>
            </View>
            <Text style={styles.rateAndReviewTitle}>Rate and Review</Text>
            {myReview === null || myReview === undefined ? (
              ...
              <View style={styles.reviewContainer}>
                <View style={styles.ratingDisplayContainer}>
                  <Text style={styles.ratingDisplayTitle}>
                    My Review{" "}
                    <FontAwesome
                      onPress={() => {
                        setEditReviewModal(!editReviewModal);
